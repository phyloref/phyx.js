window.esdocSearchIndex = [
  ...
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber126",
    "PhyxWrapper",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber127",
    "PhyxWrapper should use the defaultNomenclaturalCodeIRI for phylogeny nodes",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber197",
    "PhyxWrapper should use the inferred nomenclatural code for phylogeny nodes",
    "test"
  ],
  [
    "",
  ...
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber101",
    "TaxonConceptWrapper",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber102",
    "TaxonConceptWrapper #nomenCode",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber105",
    "TaxonConceptWrapper #nomenCode should return UNKNOWN_CODE if one is not set",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber109",
    "TaxonConceptWrapper #nomenCode should return the default nomenclatural code if one is provided",
    "test"
  ],
  [
    "",
  ...
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber41",
    "TaxonNameWrapper",
    "test"
  ],
  [
  ...
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber56",
    "TaxonNameWrapper #getNomenCodeDetails",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber57",
    "TaxonNameWrapper #getNomenCodeDetails should provide details for some built-in codes",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber42",
    "TaxonNameWrapper #getNomenclaturalCodes",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber43",
    "TaxonNameWrapper #getNomenclaturalCodes should provide a non-empty list with the expected keys",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber76",
    "TaxonNameWrapper #nomenclaturalCodeDetails",
    "test"
  ],
  [
    "",
    "test-file/test/nomenclatural-codes.js.html#lineNumber77",
    "TaxonNameWrapper #nomenclaturalCodeDetails should provide nomenclatural code details for an example taxon name",
    "test"
  ],
  [
    "",
  ...
  [
    "src/wrappers/citationwrapper.js~citationwrapper.getagentname",
    "class/src/wrappers/CitationWrapper.js~CitationWrapper.html#static-method-getAgentName",
    "src/wrappers/CitationWrapper.js~CitationWrapper.getAgentName",
    "method"
  ],
  [
  ...
  [
    ...
    "class/src/wrappers/PhylorefWrapper.js~PhylorefWrapper.html#instance-method-createClassExpressionsForInternals",
    "src/wrappers/PhylorefWrapper.js~PhylorefWrapper#createClassExpressionsForInternals",
    "method"
  ],
  [
    "src/wrappers/phylorefwrapper.js~phylorefwrapper#createcomponentclass",
    "class/src/wrappers/PhylorefWrapper.js~PhylorefWrapper.html#instance-method-createComponentClass",
    "src/wrappers/PhylorefWrapper.js~PhylorefWrapper#createComponentClass",
    "method"
  ],
  [
  ...
  [
    ...
    "class/src/wrappers/PhylorefWrapper.js~PhylorefWrapper.html#instance-method-getIncludesRestrictionForTU",
    "src/wrappers/PhylorefWrapper.js~PhylorefWrapper#getIncludesRestrictionForTU",
    "method"
  ],
  [
    "src/wrappers/phylorefwrapper.js~phylorefwrapper#getmrcarestrictionoftwotus",
    "class/src/wrappers/PhylorefWrapper.js~PhylorefWrapper.html#instance-method-getMRCARestrictionOfTwoTUs",
    "src/wrappers/PhylorefWrapper.js~PhylorefWrapper#getMRCARestrictionOfTwoTUs",
    "method"
  ],
  [
  ...
  [
    "src/wrappers/phyxwrapper.js~phyxwrapper#defaultnomencode",
    "class/src/wrappers/PhyxWrapper.js~PhyxWrapper.html#instance-get-defaultNomenCode",
    "src/wrappers/PhyxWrapper.js~PhyxWrapper#defaultNomenCode",
    "member"
  ],
  [
