...
describe('bin/resolve.mjs', function () {
  ...
  it('should provide the expected results on the `brochu_2003.json` example file', function () {
    ...
    expect(resultObj.Alligatoridae[0].resolved).to.include({
      '@id': 'https://tree.opentreeoflife.org/opentree/argus/opentree16.1@ott195670',
      label: 'Alligatoridae',
    });
    expect(resultObj.Alligatorinae[0].resolved).to.include({
      '@id': 'https://tree.opentreeoflife.org/opentree/argus/opentree16.1@ott151255',
      label: 'Alligatorinae',
    });
    expect(resultObj.Crocodylidae[0].resolved).to.include({
      '@id': 'https://tree.opentreeoflife.org/opentree/argus/opentree16.1@ott1092501',
      label: 'Longirostres',
    });
